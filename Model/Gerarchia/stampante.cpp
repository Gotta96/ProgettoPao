...
Stampante::Stampante(const Stampante& printer): Item(printer),daycost(printer.daycost), wifi(printer.wifi), doubleside(printer.doubleside), color(printer.color),used(printer.used),photo(printer.photo){}
